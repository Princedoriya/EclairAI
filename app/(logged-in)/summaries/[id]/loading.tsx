    ...
    <div className="relative isolate min-h-screen bg-linear-to-b from-rose-50/40 to-white">
     ...
     gap-4 text-sm text-muted-foreground"
            ...
            <div className="relative overflow-hidden">
              <div className="relative p-4 sm:p-6 lg:p-8 bg-white/80 backdrop-blur-md rounded-2xl border border-rose-100/30">
                {/*Gradient background */}
                <div className="absolute inset-0 bg-gradient-to-br from-rose-50/50 via-orange-50/30 to-transparent opacity-50 rounded-3xl">
                  ...
                  <div className="h-3 w-3 sm:h-4 sm:w-4 text-rose-400">
