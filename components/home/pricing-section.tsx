...
const PricingCard = ({
  ...
  return (
    <MotionDiv variants={listVariant} className="relative w-full max-w-lg hover:scale-105 hover:transition-all duration-300">
      <div className={cn("relative flex flex-col h-full gap-4 lg:gap-8 z-10 p-8 border-[1px] border-gray-500/20 rounded-2xl", id === 'pro' && 'border-rose-500 gap-5 border-2')}>
        <div className="flex justify-between items-center gap-4">
          ...
          <div className="flex flex-col justify-end mb-[4px]">
            ...
            {id !== 'free' && <p className="text-xs">/month</p>}
          </div>
        </MotionDiv>
      ...
      <MotionDiv variants={listVariant} className="flex justify-center w-full space-y-2">
        {id === 'free' ? (
          <div className="inline-block text-md w-full text-center px-4 font-semibold text-white border-gray-700 border-2 py-2 bg-green-600 rounded-full cursor-default select-none">
            Free Plan
          </div>
        ) : (
  ...
  return (
    ...
    className="relative overflow-hidden'" id='pricing'>
      <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 lg:pt-12">
        <MotionDiv variants={itemVariants} whileHover={{ scale : 1.02 }} className="flex items-center justify-center w-full pb-12">
